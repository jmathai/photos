<?php
  ...
  $campaignName = '2006_community';
  
  $subject = 'Easy Sharing in the New FotoFlix Community!';
  $template = file_get_contents('./script_emailer_' . $campaignName . '.html');
  ...
  foreach($users as $v)
  {
    $body = str_replace('{EMAIL_FOOTER}', emailFooter($v['u_key'], $campaignId, 'link'), $template);
