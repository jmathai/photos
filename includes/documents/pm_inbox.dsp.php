<?php
  ...
  else 
  {
    ...
    $messages = $pm->getReceivedMessages($_USER_ID, $limit, $offset);
  ...
  ?>
    ...
    <div style="text-align:left; padding-top:25px; padding-left:25px;">
      ...
      <div style="padding-top:25px;" class="f_8 bold">
        ...
        <div style="float:left; width:25%; border:solid gray 1px; text-align:center;">Sender</div>
        <div style="float:left; width:25%; border:solid gray 1px; text-align:center;">Date Received</div>
      </div>
      <div>
        <?php
          foreach($messages as $k => $v)
          {
            echo '<div style="padding-top:25px;" class="f_8">';
              ...
              echo '<div style="float:left; width:45%; padding-left:5px;"><a href="/?action=pm.message&type=received&id=' . $v['PM_ID'] . '">' . $v['PM_SUBJECT'] . '</a></div>';
              echo '<div style="float:left; width:25%; text-align:center;">' . $v['U_SENDER_USERNAME'] . '</div>';
