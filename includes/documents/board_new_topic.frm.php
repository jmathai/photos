...
<div class="dataSingleContent">
  ...
  <div style="padding-bottom:5px;">
    <a href="/?action=board.main">Community</a> >> <a href="/?action=board.board_view&board_id=<?php echo $bID ?>"><?php echo $boardData['B_TITLE']; ?></a> >> (New Topic)
  </div>
  ...
  <div style="width:735px;">
    ...
    <div style="height:385px; border-left:solid 1px #cbccd0; border-bottom:solid 1px #cbccd0; border-right:solid 1px #cbccd0;">
      <div style="width:504px; height:100%; float:left;" class="bg_lite">
        <form style="display:inline;" name="_newTopic" action="/?action=board.new_topic.act" method="post">
          <div>
