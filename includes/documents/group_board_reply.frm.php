...
?>
  ...
  <div style="padding-bottom:10px;">
    <a href="/?action=group.board_main&group_id=<?php echo $postData['BP_BID']; ?>"><?php echo $boardData['B_TITLE']; ?></a> >> <a href="/?action=group.board_post&group_id=<?php echo $g_id; ?>&post_id=<?php echo $pID; ?>"><?php echo $postData['BP_TITLE']; ?></a> >> (Reply)
  </div>
  
  <div style="width:685px; margin-bottom:15px; padding-bottom:15px;">
    ...
    <div style="height:385px; border-left:solid 1px #cbccd0; border-bottom:solid 1px #cbccd0; border-right:solid 1px #cbccd0;">
      <div style="width:454px; height:100%; float:left;" class="bg_lite">
        <form style="display:inline;" name="_reply" action="/?action=group.board_reply.act&post_id=<?php echo $pID; ?>" method="post">
    ...
    <div style="margin-top:1px; height:100%; min-height:165px; _height:165px;" class="bg_lite">
      <div style="float:left; width:147px;">
        ...
        <div style="float:left; padding-left:3px; padding-top:10px;">
          ...
          <div style="float:left; padding-left:2px; padding-top:2px;" class="f_7 f_dark"><a href="/users/<?php echo $userData['U_USERNAME']; ?>" style="text-decoration:none;">Photo Page</a></div>
      ...
      <div style="float:left; width:533px; border-left:solid 1px #ffffff; min-height:165px; _height:165px;">
